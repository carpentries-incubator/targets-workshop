...
#| eval: FALSE
#| label: load-pkg-show
#| file: files/plans/plan_option_packages.R
```
...
#| label: load-pkg-hide
tar_dir({
  write_example_plan("plan_option_packages.R")
  tar_make()
})
```
...
#| file: files/plans/plan_packages_argument.R
```
...
tar_dir({
  write_example_plan("plan_packages_argument.R")
  tar_make()
})
```
...
#| file: files/plans/plan_packages_colon.R
```
...
tar_dir({
  write_example_plan("plan_packages_colon.R")
  tar_make()
})
```
