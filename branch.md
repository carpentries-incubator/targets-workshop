...
✔ adelie_model completed [19ms, 6.47 kB]
...
✔ gentoo_summary completed [4ms, 348 B]
+ chinstrap_summary dispatched
✔ chinstrap_summary completed [3ms, 349 B]
✔ ended pipeline [382ms, 7 completed, 4 skipped]
```
...
✔ ended pipeline [342ms, 4 completed, 4 skipped]
```
...
✔ ended pipeline [449ms, 9 completed, 2 skipped]
```
