...
● completed target combined_model [0.035 seconds, 11.201 kilobytes]
...
● completed target penguins_data_grouped [0.007 seconds, 1.527 kilobytes]
...
● completed branch species_summary_af3bb92d1b0f36d3 [0.006 seconds, 348 bytes]
● completed pattern species_summary 
▶ ended pipeline [0.303 seconds]
```
...
● completed target penguins_data [0.023 seconds, 1.527 kilobytes]
▶ dispatched target combined_summary
● completed target combined_summary [0.015 seconds, 371 bytes]
