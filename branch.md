...
● built target combined_model [0.038 seconds]
▶ end pipeline [0.106 seconds]
```
...
● built target combined_summary [0.007 seconds]
▶ start target interaction_summary
● built target interaction_summary [0.035 seconds]
▶ start target species_summary
● built target species_summary [0.003 seconds]
▶ end pipeline [0.134 seconds]
```
...
● built branch model_summaries_5ad4cec5 [0.007 seconds]
...
● built branch model_summaries_91696941 [0.032 seconds]
...
✔ skip target models
▶ start branch model_summaries_5ad4cec5
● built branch model_summaries_5ad4cec5 [0.014 seconds]
▶ start branch model_summaries_c73912d5
● built branch model_summaries_c73912d5 [0.038 seconds]
▶ start branch model_summaries_91696941
● built branch model_summaries_91696941 [0.004 seconds]
● built pattern model_summaries
▶ end pipeline [0.141 seconds]
```
