...
✔ ended pipeline [301ms, 1 completed, 0 skipped]
```
...
``` output
✔ skipped pipeline [164ms, 1 skipped]
```
...
✔ ended pipeline [356ms, 2 completed, 0 skipped]
```
...
✔ penguins_data_raw_file completed [2ms, 53.10 kB]
+ penguins_data_raw dispatched
✔ penguins_data_raw completed [130ms, 10.40 kB]
+ penguins_data dispatched
✔ penguins_data completed [22ms, 1.50 kB]
✔ ended pipeline [386ms, 3 completed, 0 skipped]
```
...
✔ ended pipeline [392ms, 4 completed, 0 skipped]
```
