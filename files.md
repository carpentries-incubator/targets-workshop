...
✔ some_data completed [0ms, 63 B]
✔ ended pipeline [101ms, 1 completed, 0 skipped]
```
...
``` output
✔ skipped pipeline [60ms, 1 skipped]
```
...
+ some_data dispatched
✔ some_data completed [0ms, 77 B]
✔ ended pipeline [137ms, 2 completed, 0 skipped]
```
...
✔ penguins_data_raw completed [173ms, 10.40 kB]
