...
✔ ended pipeline [122ms, 1 completed, 0 skipped]
```
...
``` output
✔ skipped pipeline [82ms, 1 skipped]
```
...
✔ ended pipeline [158ms, 2 completed, 0 skipped]
```
...
✔ penguins_data_raw completed [78ms, 10.40 kB]
+ penguins_data dispatched
✔ penguins_data completed [16ms, 1.49 kB]
✔ ended pipeline [252ms, 3 completed, 0 skipped]
```
...
✔ ended pipeline [230ms, 4 completed, 0 skipped]
```
