...
✔ ended pipeline [310ms, 1 completed, 0 skipped]
```
...
``` output
✔ skipped pipeline [170ms, 1 skipped]
```
...
✔ ended pipeline [363ms, 2 completed, 0 skipped]
```
...
✔ ended pipeline [388ms, 3 completed, 0 skipped]
```
