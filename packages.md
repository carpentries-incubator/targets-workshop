...
✔ ended pipeline [374ms, 1 completed, 0 skipped]
```
...
``` output
+ adelie_data dispatched
✔ adelie_data completed [38ms, 1.54 kB]
✔ ended pipeline [378ms, 1 completed, 0 skipped]
```
...
✔ ended pipeline [365ms, 1 completed, 0 skipped]
```
