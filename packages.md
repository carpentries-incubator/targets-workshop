...
● completed target adelie_data [0.074 seconds, 1.544 kilobytes]
...
``` output
▶ dispatched target adelie_data
● completed target adelie_data [0.076 seconds, 1.544 kilobytes]
...
``` output
▶ dispatched target adelie_data
● completed target adelie_data [0.067 seconds, 1.544 kilobytes]
