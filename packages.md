...
✔ ended pipeline [141ms, 1 completed, 0 skipped]
```
...
``` output
+ adelie_data dispatched
✔ adelie_data completed [19ms, 1.54 kB]
✔ ended pipeline [144ms, 1 completed, 0 skipped]
```
...
``` output
+ adelie_data dispatched
✔ adelie_data completed [10ms, 1.54 kB]
