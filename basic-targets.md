...
● completed target penguins_data_raw [0.102 seconds, 10.403 kilobytes]
▶ dispatched target penguins_data
● completed target penguins_data [0.02 seconds, 1.613 kilobytes]
▶ ended pipeline [0.249 seconds]
```
